...
void InitImage(ECECITY* ececity){
    ...
    ececity->tabImage[BOUTONEAU].format.width = 100;
    ececity->tabImage[BOUTONEAU].format.x = 60;
    ...
    ececity->tabImage[BOUTONELEC].format.width = 100;
    ececity->tabImage[BOUTONELEC].format.height = 60;
    ececity->tabImage[BOUTONELEC].format.x = 30;
    ...
    ececity->tabImage[BOUTONEXIT].format.width = 100;
    ececity->tabImage[BOUTONEXIT].format.height = 60;
    ececity->tabImage[BOUTONEXIT].format.x = 30;
    ...
    ececity->tabImage[BOUTONMAISON].format.width = 200;
    ececity->tabImage[BOUTONMAISON].format.height = 100;
    ececity->tabImage[BOUTONMAISON].format.x = 30;
    ...
    ececity->tabImage[BOUTONPAUSE].format.width = 200;
    ececity->tabImage[BOUTONPAUSE].format.height = 100;
    ececity->tabImage[BOUTONPAUSE].format.x = 30;
